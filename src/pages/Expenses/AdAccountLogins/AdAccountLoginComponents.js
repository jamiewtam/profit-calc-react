  ...
  return (
    <React.Fragment>
      <CardContainer title="Facebook Ads">
        ...
        <br />
        <button class="btn-outline-light btn-lg" id="submit-facebook-accounts">
          <FaPaperPlane /> Update Facebook Ad Accounts
        </button>
      </CardContainer>
      <CardContainer title="Remove Facebook Ads Account">
        <button class="btn-outline-light btn-lg" id="remove-facebook">
  ...
  return (
    <React.Fragment>
      ...
      <CardContainer title="Google Ads Account Id">
        ...
        />
        <br />
        <button class="btn-outline-light btn-lg" id="submit-adwords-id">
      ...
      <CardContainer title="Remove Google Ads Account">
        <button class="btn-outline-light btn-lg" id="remove-adwords">
  ...
  return (
    <React.Fragment>
      ...
      <CardContainer title="Remove Bing Ads">
        <button class="btn-outline-light btn-lg" id="remove-bing">
